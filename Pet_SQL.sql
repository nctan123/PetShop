...
VALUES ('A', 'Booking', 'Pet-sitting service', 1),
       ('B', 'Checkup', 'Pet take care service', 1),
	   ('C', 'Pain_Management', 'Pet take care service', 1),
	   ('D', 'Vaccinations', 'Pet take care service', 1),
       ('E', 'Grooming', 'Pet beauty service', 1),
       ('F', 'Food', 'Product of pet food', 1);
